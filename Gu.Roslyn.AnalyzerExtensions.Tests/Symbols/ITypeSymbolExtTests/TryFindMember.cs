namespace Gu.Roslyn.AnalyzerExtensions.Tests.Symbols.ITypeSymbolExtTests
{
    ...
    public static class TryFindMember
    {
        [Test]
        public static void TryFindField()
        {
...
namespace N
{
    public class C
    {
        ...
        [Test]
        public static void TryFindEvent()
        {
            var syntaxTree = CSharpSyntaxTree.ParseText(
                @"
namespace N
{
    ...
    internal class C
    {
        ...
        [Test]
        public static void TryFindProperty()
        {
            var syntaxTree = CSharpSyntaxTree.ParseText(
                @"
namespace N
{
    public class C
    {
        ...
        [Test]
        public static void TryFindMethodWhenOverridden()
        {
            var syntaxTree = CSharpSyntaxTree.ParseText(
                @"
namespace N
{
    public class C
    {
        ...
        public static void TryFindMethod(string name)
        {
            var syntaxTree = CSharpSyntaxTree.ParseText(
                @"
namespace N
