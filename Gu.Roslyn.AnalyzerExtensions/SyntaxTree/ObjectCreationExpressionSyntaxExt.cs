namespace Gu.Roslyn.AnalyzerExtensions
{
    ...
    public static class ObjectCreationExpressionSyntaxExt
    {
        ...
        public static bool TryGetConstructorDeclaration(this ObjectCreationExpressionSyntax invocation, SemanticModel semanticModel, CancellationToken cancellationToken, out ConstructorDeclarationSyntax declaration)
        {
            declaration = null;
