namespace Gu.Roslyn.AnalyzerExtensions
{
    ...
    public static class ParameterListSyntaxExt
    {
        ...
        /// <returns>The <see cref="ParameterSyntax"/>. if a match was found.</returns>
        public static ParameterSyntax? Find(this ParameterListSyntax parameterList, string name)
        {
